...
恐れ入りますがお問い合わせページよりお問い合わせください。',
    ...
    'admin.holiday.up.complete' => '定休日を上へ移動しました。',
    'admin.holiday.up.error' => '定休日を上へ移動できませんでした。',
    'admin.holiday.down.complete' => '定休日を下へ移動しました。',
    'admin.holiday.down.error' => '定休日を下へ移動できませんでした。',
    'admin.holiday.save.complete' => '定休日を保存しました。',
    'admin.holiday.save.error' => '定休日を保存できませんでした。',
    'admin.holiday.delete.complete' => '定休日を削除しました。',
    'admin.holiday.delete.error' => '定休日を削除できませんでした。',
    ...
    'admin.mailtemplateeditor.mail.edit.error' => '対象ファイルが存在しません。',
    'admin.mailtemplateeditor.mail.init.complete' => '初期設定に戻しました。',
    'admin.plugin.order_pdf.parameter.notfound' => '注文番号がありません。',
    'admin.plugin.order_pdf.download.failure' => 'ダウンロード失敗!',
    'admin.plugin.order_pdf.title.default' => 'お買上げ明細書(納品書)',
    'admin.plugin.order_pdf.message1.default' => 'このたびはお買上げいただきありがとうございます。',
    'admin.plugin.order_pdf.message2.default' => '下記の内容にて納品させていただきます。',
    'admin.plugin.order_pdf.message3.default' => 'ご確認くださいますよう、お願いいたします。',
    ...
    'admin.product.option.csv_import.save.complete' => 'オプション割当CSVファイルをアップロードしました。',
