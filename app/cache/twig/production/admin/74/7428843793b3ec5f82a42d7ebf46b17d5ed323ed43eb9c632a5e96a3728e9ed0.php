...
class __TwigTemplate_a077b4c420655a49d696f26f491dcdcfa6af02c9f365eaac8ca69d2c322934b9 extends Twig_Template
{
        ...
        <div class=\"table-responsive with-border\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["Plugin"]) {
                ...
                if (($this->getAttribute($context["Plugin"], "enable", array()) == 1)) {
                    // line 43
                    echo "                                    <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_store_plugin_disable", array("id" => $this->getAttribute($context["Plugin"], "id", array()))), "html", null, true);
                    echo "\" ";
                    ...
                    // line 47
                    echo "                                    <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_store_plugin_enable", array("id" => $this->getAttribute($context["Plugin"], "id", array()))), "html", null, true);
                    echo "\" ";
                    echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getCsrfTokenForAnchor();
                    echo " data-method=\"put\" data-confirm=\"false\">
                                        有効にする
                ...
                echo "                                /
                                <a href=\"";
                // line 52
                echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_store_plugin_uninstall", array("id" => $this->getAttribute($context["Plugin"], "id", array()))), "html", null, true);
                echo "\" ";
                echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getCsrfTokenForAnchor();
                ...
                if (($this->getAttribute($context["Plugin"], "source", array()) == 0)) {
                    ...
                    // line 69
                    echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_store_plugin_update", array("id" => $this->getAttribute($context["Plugin"], "id", array()))), "html", null, true);
                    echo "', '";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "vars", array()), "name", array()), "html", null, true);
                    echo "');\">
                                    アップロード
                    ...
                    if (($this->getAttribute($context["Plugin"], "updateStatus", array()) == 3)) {
                        ...
                        // line 75
                        echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_store_plugin_upgrade", array("action" => "update", "id" => $this->getAttribute($context["Plugin"], "source", array()), "version" => $this->getAttribute($context["Plugin"], "version", array()))), "html", null, true);
                        echo "\">今すぐ更新</a>
                                    </p>
                        ...
                        // line 80
                        echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getTimeAgo($this->getAttribute($context["Plugin"], "lastUpdateDate", array())), "html", null, true);
                        echo "</li>
                                    </ul>
                                ";
                    } else {
...
";
    ...
    {
        return new Twig_Source("", "Store/plugin_table.twig", "/home/cssv15/tiara-collection.com/public_html/src/Eccube/Resource/template/admin/Store/plugin_table.twig");
    }
}
