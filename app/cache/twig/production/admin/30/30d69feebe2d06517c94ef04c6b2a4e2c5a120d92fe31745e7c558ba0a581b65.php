...
/* default_frame.twig */
class __TwigTemplate_295b3f988b9a9d0434d43d5e7fa98fed13625553675164606935042166b7e4ae extends Twig_Template
{
...
<div id=\"wrapper\" class=\"sidebar-open\">
    ...
    <header id=\"header\" role=\"navigation\">
        ...
        if ($this->env->getExtension('Symfony\Bridge\Twig\Extension\SecurityExtension')->isGranted("ROLE_ADMIN")) {
            ...
            // line 74
            echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_change_password");
            echo "\">パスワード変更</a>
                            <a class=\"btn btn-primary btn-xs\" href=\"";
            // line 75
            echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl(($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "admin_route", array()) . "_logout"));
            echo "\">ログアウト</a>
                        </dd>
                    ";
        }
...
";
    ...
    {
        return new Twig_Source("", "default_frame.twig", "/home/cssv15/tiara-collection.com/public_html/src/Eccube/Resource/template/admin/default_frame.twig");
    }
}
