...
/* __string_template__c41e6031d0ec7f964d61256285eb5d20b39c64f9dbe56f5c84a71db3e625be7b */
class __TwigTemplate_e70412db03c9d34ed1a4966f000365ce7cc011346dbc23d5e24eae129bd936ec extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__c41e6031d0ec7f964d61256285eb5d20b39c64f9dbe56f5c84a71db3e625be7b", 22);
        $this->blocks = array(
        ...
        \$(function() {
            ...
            var updateRank = function() {
                ...
                \$.ajax({
                    url: '";
        // line 65
        echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_product_class_name_rank_move");
        echo "',
                    type: 'POST',
                    data: newRanks,
                }).done(function(data) {
...
";
    ...
    public function block_main($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute((isset($context["TargetClassName"]) ? $context["TargetClassName"] : null), "id", array())) {
            echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getPath("admin_product_class_name_edit", array("id" => $this->getAttribute((isset($context["TargetClassName"]) ? $context["TargetClassName"] : null), "id", array()))), "html", null, true);
        } else {
            echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_product_class_name");
        }
        echo "\">
        ...
        echo "
                                ";
        // line 89
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\FormExtension')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "name", array()), 'widget', array("attr" => array("placeholder" => "規格名を入力")));
        echo "
                                ";
        // line 90
        ...
        if ((twig_length_filter($this->env, (isset($context["ClassNames"]) ? $context["ClassNames"] : null)) > 0)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["ClassName"]) {
                ...
                echo "\" class=\"item_pattern td\">
                                            <a href=\"";
                // line 117
                echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_product_class_category", array("class_name_id" => $this->getAttribute($context["ClassName"], "id", array()))), "html", null, true);
                echo "\">
                                                ";
                // line 118
                ...
                if (($this->getAttribute($context["ClassName"], "id", array()) != $this->getAttribute((isset($context["TargetClassName"]) ? $context["TargetClassName"] : null), "id", array()))) {
                    // line 132
                    echo "                                                        <li><a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_product_class_name_edit", array("id" => $this->getAttribute($context["ClassName"], "id", array()))), "html", null, true);
                    echo "\">編集</a></li>
                                                    ";
                } else {
                    // line 134
                ...
                if ((twig_length_filter($this->env, $this->getAttribute($context["ClassName"], "ClassCategories", array())) == 0)) {
                    ...
                    echo "                                                        <li>
                                                            <a href=\"";
                    // line 139
                    echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_product_class_name_delete", array("id" => $this->getAttribute($context["ClassName"], "id", array()))), "html", null, true);
                    echo "\" ";
...
";
    ...
    {
        return "__string_template__c41e6031d0ec7f964d61256285eb5d20b39c64f9dbe56f5c84a71db3e625be7b";
    }
    ...
    {
        return new Twig_Source("", "__string_template__c41e6031d0ec7f964d61256285eb5d20b39c64f9dbe56f5c84a71db3e625be7b", "");
    }
}
