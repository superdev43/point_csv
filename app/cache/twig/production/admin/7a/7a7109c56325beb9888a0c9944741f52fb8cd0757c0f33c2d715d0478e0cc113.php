...
/* __string_template__81d3b6ee766d2957f867acfebb49c4a0a0a5184409221c4434b3d8b56205e697 */
class __TwigTemplate_3a0d3a1f8e75ad9d5848c3f7b1ae9f74ac986dbba35e5d20a7f50bfa7280606e extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 24
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__81d3b6ee766d2957f867acfebb49c4a0a0a5184409221c4434b3d8b56205e697", 24);
        $this->blocks = array(
    ...
    <div id=\"page_list\" class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["PageLayout"]) {
            ...
            echo "\" class=\"dropdown-menu dropdown-menu-right\">
                                                <li>
                                                    <a href=\"";
            // line 66
            echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_content_layout_edit", array("id" => $this->getAttribute($context["PageLayout"], "id", array()))), "html", null, true);
            echo "\" >レイアウト編集</a>
                                                </li>
                                                <li>
                                                    ";
            ...
            if ((twig_length_filter($this->env, $this->getAttribute($context["PageLayout"], "filename", array())) >= 1)) {
                // line 70
                echo "                                                        <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_content_page_edit", array("id" => $this->getAttribute($context["PageLayout"], "id", array()))), "html", null, true);
                echo "\">ページ編集</a>
                                                    ";
            } else {
                // line 72
            ...
            if (($this->getAttribute($context["PageLayout"], "edit_flg", array()) == twig_constant("Eccube\\Entity\\PageLayout::EDIT_FLG_USER"))) {
                // line 77
                echo "                                                        <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_content_page_delete", array("id" => $this->getAttribute($context["PageLayout"], "id", array()))), "html", null, true);
                echo "\" ";
        ...
        // line 97
        echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl("admin_content_page_new");
        echo "\">新規入力</a>
            </div>
        </div>
...
";
    ...
    {
        return "__string_template__81d3b6ee766d2957f867acfebb49c4a0a0a5184409221c4434b3d8b56205e697";
    }
    ...
    {
        return new Twig_Source("", "__string_template__81d3b6ee766d2957f867acfebb49c4a0a0a5184409221c4434b3d8b56205e697", "");
    }
}
