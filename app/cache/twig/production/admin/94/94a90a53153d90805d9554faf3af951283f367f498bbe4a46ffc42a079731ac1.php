...
/* nav.twig */
class __TwigTemplate_3d0e432475ca69ca4884d1382abdf05d1ba29fecfbf9dd51a80f5d031eacd4e0 extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["level1"]) {
            if (!twig_in_filter((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "baseUrl", array()) . "/") . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "admin_route", array())) . "/") . $this->getAttribute($context["level1"], "id", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null))) {
                // line 24
                echo "    <li class=\"";
                if (($this->getAttribute($this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 0, array(), "array") == $this->getAttribute($context["level1"], "id", array()))) {
                    echo "active";
                }
                echo "\">
        ";
                ...
                ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["level2"]) {
                        if (!twig_in_filter((((((($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "baseUrl", array()) . "/") . $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "admin_route", array())) . "/") . $this->getAttribute($context["level1"], "id", array())) . "/") . $this->getAttribute($context["level2"], "id", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null))) {
                            // line 33
                            echo "                    ";
                            if (($this->getAttribute($context["level2"], "url", array(), "any", true, true) && twig_in_filter($this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getPath($this->getAttribute($context["level2"], "url", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null)))) {
                                // line 34
                                echo "                    ";
                            } else {
                                // line 35
                                echo "                    <li class=\"";
                                if (($this->getAttribute($this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 1, array(), "array") == $this->getAttribute($context["level2"], "id", array()))) {
                                    echo "active";
                                }
                                echo "\">
                        ";
                            ...
                            <ul ";
                                ...
                                ";
                                    ...
                                    foreach ($context['_seq'] as $context["_key"] => $context["level3"]) {
                                        // line 43
                                        echo "                                    ";
                                        if (($this->getAttribute($context["level3"], "url", array(), "any", true, true) && twig_in_filter($this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getPath($this->getAttribute($context["level3"], "url", array())), (isset($context["AuthorityRoles"]) ? $context["AuthorityRoles"] : null)))) {
                                            // line 44
                                            echo "                                    ";
                                        } else {
                                            // line 45
                                            echo "                                    <li class=\"";
                                            if (($this->getAttribute($this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getActiveMenus((isset($context["menus"]) ? $context["menus"] : null)), 2, array(), "array") == $this->getAttribute($context["level3"], "id", array()))) {
                                                echo "active";
                                            }
                                            echo "\">
                                        <a href=\"";
                                            // line 46
                                            echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl($this->getAttribute($context["level3"], "url", array()));
                                            echo "\">
                                            ";
                                            // line 47
                        ...
                        ";
                                    ...
                                    // line 54
                                    echo "                            <a href=\"";
                                    echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl($this->getAttribute($context["level2"], "url", array()));
                                    echo "\">
                                ";
                                    // line 55
                                    echo twig_escape_filter($this->env, $this->getAttribute($context["level2"], "name", array()), "html", null, true);
        ...
        ";
                    ...
                    if ($this->getAttribute($context["level1"], "url", array(), "any", true, true)) {
                        // line 64
                        echo "                <a href=\"";
                        echo $this->env->getExtension('Plugin\ExcludeTax\Twig\Extension\EccubeExtension')->getUrl($this->getAttribute($context["level1"], "url", array()));
                        echo "\">
                    ";
                        // line 65
                        echo twig_escape_filter($this->env, $this->getAttribute($context["level1"], "name", array()), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("", "nav.twig", "/home/cssv15/tiara-collection.com/public_html/src/Eccube/Resource/template/admin/nav.twig");
    }
}
