...
/* __string_template__ae15afd4389e7fc89d46f1a6a7b1f0407781e301fdaeaa52d3e90ad823c35d05 */
class __TwigTemplate_5b905e3816ce869eb5a798fc4f293f0a777e5f7f8cc35bb25d71b04886e11526 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__ae15afd4389e7fc89d46f1a6a7b1f0407781e301fdaeaa52d3e90ad823c35d05", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">94pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__ae15afd4389e7fc89d46f1a6a7b1f0407781e301fdaeaa52d3e90ad823c35d05";
    }
    ...
    {
        return new Twig_Source("", "__string_template__ae15afd4389e7fc89d46f1a6a7b1f0407781e301fdaeaa52d3e90ad823c35d05", "");
    }
}
