...
/* __string_template__02c490895e6f4812e3cd410dd6a2ceaf2459b686a4d6c0c001981f23a6febfd1 */
class __TwigTemplate_edaf13ba5089cd8e3599b294ca2be50dfa3b59e00764b74fc40b38a4a7aa4ce5 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__02c490895e6f4812e3cd410dd6a2ceaf2459b686a4d6c0c001981f23a6febfd1", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">24pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__02c490895e6f4812e3cd410dd6a2ceaf2459b686a4d6c0c001981f23a6febfd1";
    }
    ...
    {
        return new Twig_Source("", "__string_template__02c490895e6f4812e3cd410dd6a2ceaf2459b686a4d6c0c001981f23a6febfd1", "");
    }
}
