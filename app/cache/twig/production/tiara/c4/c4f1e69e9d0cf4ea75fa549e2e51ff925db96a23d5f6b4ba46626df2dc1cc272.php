...
/* __string_template__e10dac99ea34885562bbff4a5411bf0965d8d5a3f753b3f39ead8c70bfb8ebc5 */
class __TwigTemplate_25b4e6bc5ed0297e98b3c92157c0072fad357a8386f81403288d5d035a579fe5 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__e10dac99ea34885562bbff4a5411bf0965d8d5a3f753b3f39ead8c70bfb8ebc5", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">350pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__e10dac99ea34885562bbff4a5411bf0965d8d5a3f753b3f39ead8c70bfb8ebc5";
    }
    ...
    {
        return new Twig_Source("", "__string_template__e10dac99ea34885562bbff4a5411bf0965d8d5a3f753b3f39ead8c70bfb8ebc5", "");
    }
}
