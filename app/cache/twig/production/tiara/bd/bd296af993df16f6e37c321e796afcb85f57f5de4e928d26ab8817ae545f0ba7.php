...
/* __string_template__745dbf65f8291aa6f7dfccd51eb6ecd4947eb03ed5066bcd162a77a8a19a67d8 */
class __TwigTemplate_f6d66cdafe7d646796f550aca21647b3aa4f1717ad143d19c5019440cbadbd15 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__745dbf65f8291aa6f7dfccd51eb6ecd4947eb03ed5066bcd162a77a8a19a67d8", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">140pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__745dbf65f8291aa6f7dfccd51eb6ecd4947eb03ed5066bcd162a77a8a19a67d8";
    }
    ...
    {
        return new Twig_Source("", "__string_template__745dbf65f8291aa6f7dfccd51eb6ecd4947eb03ed5066bcd162a77a8a19a67d8", "");
    }
}
