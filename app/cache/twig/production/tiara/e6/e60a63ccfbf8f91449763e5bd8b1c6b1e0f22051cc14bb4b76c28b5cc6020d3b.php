...
/* __string_template__47b18a74ea2641b7fe254f5b2315fc45c4a159765bf8053adc8a8dc680e40b26 */
class __TwigTemplate_5e8d2f932b3976c707eb7b2a1259561ec4ad77a739267396489c7ec7a5f64faa extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__47b18a74ea2641b7fe254f5b2315fc45c4a159765bf8053adc8a8dc680e40b26", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    現在の保有ポイントは「<strong class=\"text-primary\">24 pt</strong>」です。<br/>
    商品購入で加算されるポイントは「<strong class=\"text-primary\">5pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__47b18a74ea2641b7fe254f5b2315fc45c4a159765bf8053adc8a8dc680e40b26";
    }
    ...
    {
        return new Twig_Source("", "__string_template__47b18a74ea2641b7fe254f5b2315fc45c4a159765bf8053adc8a8dc680e40b26", "");
    }
}
