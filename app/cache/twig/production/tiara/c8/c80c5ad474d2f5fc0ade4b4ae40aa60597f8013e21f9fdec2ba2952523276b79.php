...
/* __string_template__924416bff5a79dca100926b2c1997d83272d952de5fbc5104446ee76c2b6520a */
class __TwigTemplate_197b8b9d2aa5d46b31d7452a2faaf22dd1075341d07e94e4d2733d946c073358 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__924416bff5a79dca100926b2c1997d83272d952de5fbc5104446ee76c2b6520a", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    現在の保有ポイントは「<strong class=\"text-primary\">80 pt</strong>」です。<br/>
    商品購入で加算されるポイントは「<strong class=\"text-primary\">160pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__924416bff5a79dca100926b2c1997d83272d952de5fbc5104446ee76c2b6520a";
    }
    ...
    {
        return new Twig_Source("", "__string_template__924416bff5a79dca100926b2c1997d83272d952de5fbc5104446ee76c2b6520a", "");
    }
}
