...
/* __string_template__3ad99f42d15bcfdce8d127da2d648a5210742972ada2082d5f7da0d7b1194a6e */
class __TwigTemplate_abeee84a2e9af2e2f0baa2b155762906cc2a850a3c1013a6ba9551b2ed6ffdfb extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__3ad99f42d15bcfdce8d127da2d648a5210742972ada2082d5f7da0d7b1194a6e", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">720pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__3ad99f42d15bcfdce8d127da2d648a5210742972ada2082d5f7da0d7b1194a6e";
    }
    ...
    {
        return new Twig_Source("", "__string_template__3ad99f42d15bcfdce8d127da2d648a5210742972ada2082d5f7da0d7b1194a6e", "");
    }
}
