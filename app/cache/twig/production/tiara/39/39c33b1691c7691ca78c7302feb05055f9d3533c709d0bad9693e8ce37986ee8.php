...
/* __string_template__c2a63a79379bce07027de6b4ded37f474684ba84afda634563559d62a2dd1b28 */
class __TwigTemplate_eefa3ebb3428bde060494c81b0d2f26c8b68336e9436781de74893b31ed76ec4 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__c2a63a79379bce07027de6b4ded37f474684ba84afda634563559d62a2dd1b28", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    現在の保有ポイントは「<strong class=\"text-primary\">224 pt</strong>」です。<br/>
    商品購入で加算されるポイントは「<strong class=\"text-primary\">72pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__c2a63a79379bce07027de6b4ded37f474684ba84afda634563559d62a2dd1b28";
    }
    ...
    {
        return new Twig_Source("", "__string_template__c2a63a79379bce07027de6b4ded37f474684ba84afda634563559d62a2dd1b28", "");
    }
}
