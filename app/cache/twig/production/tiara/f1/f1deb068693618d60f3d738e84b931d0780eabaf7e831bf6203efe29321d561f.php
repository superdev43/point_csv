...
/* __string_template__951c9923259582cd998be0c8ed11a6e2c2f79694d993fa2f2c07e9fed0876627 */
class __TwigTemplate_5ac74d21e4035d8b3cf1d14ec8e1f4a8c83f7eeba4ac4ad57de1e452a6f3575b extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__951c9923259582cd998be0c8ed11a6e2c2f79694d993fa2f2c07e9fed0876627", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">216pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__951c9923259582cd998be0c8ed11a6e2c2f79694d993fa2f2c07e9fed0876627";
    }
    ...
    {
        return new Twig_Source("", "__string_template__951c9923259582cd998be0c8ed11a6e2c2f79694d993fa2f2c07e9fed0876627", "");
    }
}
