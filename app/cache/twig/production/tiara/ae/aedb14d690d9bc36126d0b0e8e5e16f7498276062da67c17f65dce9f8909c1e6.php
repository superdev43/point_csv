...
/* __string_template__baadd3637ebac02ffe461ff76a71ad8ccaaacda1e852d5820f5dfcd154b1a95f */
class __TwigTemplate_00361ae66dfb0f99763693d4c39e9b47031c6681838daea7b1e65b16ce3b755e extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 22
        $this->parent = $this->loadTemplate("default_frame.twig", "__string_template__baadd3637ebac02ffe461ff76a71ad8ccaaacda1e852d5820f5dfcd154b1a95f", 22);
        $this->blocks = array(
...
<!--<p align=\"center\"><span style=\"color: red;\">■システムエラーによるお詫び、お知らせ■</span><br>当サイトをリニューアル後（2017年10月）～2018年7月31日までの間、一部のお客様にポイントの付与が出来ていない症状が発生しておりました。（現在は改善しております）それに伴い、後日のポイント付与をさせて頂いておりますので改めてご確認、活用頂ければと思います。ご迷惑をお掛けしましたこと心よりお詫び申し上げます。</p>-->
    ...
    商品購入で加算されるポイントは「<strong class=\"text-primary\">431pt</strong>」です。<br/>
...
";
    ...
    {
        return "__string_template__baadd3637ebac02ffe461ff76a71ad8ccaaacda1e852d5820f5dfcd154b1a95f";
    }
    ...
    {
        return new Twig_Source("", "__string_template__baadd3637ebac02ffe461ff76a71ad8ccaaacda1e852d5820f5dfcd154b1a95f", "");
    }
}
