...
class Order extends \Eccube\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setWrapping($wrapping)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setWrapping', array($wrapping));

        return parent::setWrapping($wrapping);
    }
    ...
    public function getWrapping()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getWrapping', array());

        return parent::getWrapping();
    }
