...
namespace DoctrineProxy\__CG__\Plugin\ProductOption\Entity\Master;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Type extends \Plugin\ProductOption\Entity\Master\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Master\\Type' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Master\\Type' . "\0" . 'name', '' . "\0" . 'Plugin\\ProductOption\\Entity\\Master\\Type' . "\0" . 'rank');
        }
