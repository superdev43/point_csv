...
class Product extends \Eccube\Entity\Product implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function setListUpdate($list_update)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setListUpdate', array($list_update));

        return parent::setListUpdate($list_update);
    }
    ...
    public function getListUpdate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getListUpdate', array());

        return parent::getListUpdate();
    }
