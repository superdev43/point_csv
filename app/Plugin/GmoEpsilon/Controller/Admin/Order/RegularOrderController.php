...
class RegularOrderController extends AbstractController
{
    ...
    public function index(Application $app, Request $request, $page_no = null) {
        ...
        return $app->render('GmoEpsilon/Twig/admin/Order/regular_index.twig', array(
    ...
    public function add(Application $app, Request $request)
    {
        ...
        return $app->redirect($app->url('epsilon_regular_order_page', array('page_no' => $page_no)).'?resume='.Constant::ENABLED);
    }
    ...
    public function delete(Application $app, Request $request, $id)
    {
        ...
        if ($RegularOrder) {
            ...
            $app->deleteMessage();
            return $app->redirect($app->url('epsilon_regular_order'));
        }
