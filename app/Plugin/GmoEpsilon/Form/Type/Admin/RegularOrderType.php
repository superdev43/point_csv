    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('RegularStatus', 'entity', array(
                'class' => 'Plugin\GmoEpsilon\Entity\Master\RegularStatus',
                'property' => 'name',
                'empty_value' => false,
                'empty_data' => null,
            ))
            ...
            ->add('RegularOrderDetails', 'collection', array(
                'type' => new \Plugin\GmoEpsilon\Form\Type\Admin\RegularOrderDetailType($this->app),
                'allow_add' => true,
                'allow_delete' => true,
                'prototype' => true,
            ))
            ->add('RegularShippings', 'collection', array(
                'type' => new \Plugin\GmoEpsilon\Form\Type\Admin\RegularShippingType($this->app)
            ));
        $builder
