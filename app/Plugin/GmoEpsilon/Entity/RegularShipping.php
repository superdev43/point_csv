 ...
 * Shipping
 */
class RegularShipping extends \Eccube\Entity\AbstractEntity
{
    /**
     * @var integer
     */
    ...
    {
        $this->RegularShipmentItems = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     *
     * @param \Plugin\GmoEpsilon\Entity\RegularShipmentItem $regularShipmentItems
     * @return RegularShipping
     */
    public function addRegularShipmentItem(\Plugin\GmoEpsilon\Entity\RegularShipmentItem $regularShipmentItem)
    {
     ...
     * @param \Plugin\GmoEpsilon\Entity\RegularShipmentItem $regularShipmentItems
     */
    public function removeRegularShipmentItem(\Plugin\GmoEpsilon\Entity\RegularShipmentItem $regularShipmentItem)
    {
