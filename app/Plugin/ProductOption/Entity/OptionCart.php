...
class OptionCart extends \Eccube\Entity\AbstractEntity
{
     ...
     * @return \Eccube\Entity\Cart
     */
    public function setCartItem(\Plugin\ProductOption\Entity\OptionCartItem $AddCartItem)
    {
        $find = false;
     ...
     * @return \Eccube\Entity\Cart
     */
    public function addCartItem(OptionCartItem $CartItem)
    {
