...
namespace Plugin\ExcludeTax\Twig\Extension;
...
class EccubeExtension extends \Twig_Extension
{
    ...
    public function getFilters()
    {
        return array(
            ...
            new \Twig_SimpleFilter('no_image_url', array($this, 'getNoImageURL')),
     ...
     * @return string
     */
    public function getNoImageURL($image_url)
    {
        return empty($image_url) ? $this->app['config']['image_save_urlpath'].'/no_image_product.jpg' : $image_url;
    }
